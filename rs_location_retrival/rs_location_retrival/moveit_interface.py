...
if __name__=="__main__":
    ...
    pose_goal = move_group.get_current_pose().pose
    pose_goal.position.x = 0.0143362198089267
    pose_goal.position.y = 0.6302584119796634
    pose_goal.position.z = 0.0540909696243021
    ...
    current_pose = ur5e.move_group.get_current_pose().pose
    print(current_pose)
